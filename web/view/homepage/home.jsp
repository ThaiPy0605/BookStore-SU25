<%-- 
    Document   : Home
    Created on : Jul 11, 2025, 9:49:22 PM
    Author     : Admin
--%>
    ...
    <body class="shop">
                                            ...
                                            <div class="product-wrapper mb-40">
                                                <div class="product-img">
                                                    <a href="product-details?id=${p.id}">
                                                        <img src="${p.image}" alt="book" class="primary uniform-img" />
                                                    </a>
                            ...
                            <div class="row">
                                <div class="col-md-5 col-sm-5 col-xs-12">
                                    ...
                                    <div class="product-details-small quickview-active owl-carousel">
                                        <a class="active" href="#image-1"><img src="${p.image}" alt="" /></a>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                const quickViewButtons = document.querySelectorAll('.action-view');
